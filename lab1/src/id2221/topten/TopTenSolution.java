...
public class TopTenSolution {
	...
	public void map(Object key, Text value, Context context) throws IOException, InterruptedException {
	    Map<String, String> parsed = TopTenSolution.transformXmlToMap(value.toString());
	    if (parsed == null) {
		return;
	    }
	...
	public void reduce(NullWritable key, Iterable<Text> values, Context context) throws IOException, InterruptedException {
		...
		Map<String, String> parsed = TopTenSolution.transformXmlToMap(t.toString());
	...
	job.setJarByClass(TopTenSolution.class);
